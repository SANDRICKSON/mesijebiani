...
from wtforms import StringField, PasswordField, SubmitField, DateField, SelectField, RadioField, EmailField,TextAreaField, BooleanField
...
class MessageForm(FlaskForm):
    message = TextAreaField("დაწერეთ მესიჯი", validators=[DataRequired()])
